CREATE INDEX book_date ON book(extract(year from pub_date));
CREATE INDEX article_date ON article(extract(year from pub_date));
CREATE INDEX incollection_date ON incollection(extract(year from pub_date));
CREATE INDEX masters_thesis_date ON masters_thesis(extract(year from pub_date));
CREATE INDEX phd_thesis_date ON phd_thesis(extract(year from pub_date));
CREATE INDEX proceedings_date ON proceedings(extract(year from pub_date));
CREATE INDEX inproceedings_date ON inproceedings(extract(year from pub_date));
